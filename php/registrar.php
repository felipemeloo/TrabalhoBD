...
<h1 id="filipe">Felipinho Linhas Aéreas</h1>
	<div>
		<form action="cadastro.php" method="POST">
			...
			<input type="text" placeholder="telefone" name="telefone" name="">>
			<label>Sexo:</label>
			<input name="sexo" type="radio" value="m">Masculino
			<input name="sexo" type="radio" value="f">Feminino
			<input type="date" placeholder="dt_nasc" name ="dt_nasc">
			<input type="password" placeholder="senha" name="senha">
			<input type="submit" value="Registre-se"> <input type="reset" value="Limpar">
